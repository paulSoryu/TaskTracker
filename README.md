...
* **Layered Architecture:** The application follows a layered architecture, separating concerns into distinct layers: WebApi, Business (Anemic Domain Model), Data Access, for better maintainability and scalability.
