...
public interface ITaskService
{
    ...
    Task<Result<TaskView>> CreateAsync(SaveTaskCommand command, bool isDescendingSorting, Guid userId);
    Task<Result> UpdateAsync(SaveTaskCommand command);
    Task<Result> DeleteAsync(Guid id);
    Task<Result> ReorderTaskAsync(MoveTaskCommand command, bool isDescendingSorting);
