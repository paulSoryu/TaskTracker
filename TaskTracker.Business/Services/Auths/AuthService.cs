...
using Microsoft.AspNetCore.WebUtilities; // AspNetCore ideally shouldn't be in Business layer, but WebUtilities is an exception, as it only contains methods to work with strings, bytes and encoding, which is crucial for working with tokens
using System.Text;
...
public class AuthService(UserManager<UserEntity> userManager, TaskTrackerDbContext db) : IAuthService
{
